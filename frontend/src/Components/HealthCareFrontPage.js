...
import "./HealthCareFrontPage.css";

export const HealthCareFrontPage = () => {
        ...
        <div className="modal-container">
          <div ref={modalRef} className="modal">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <input type="text" name="prescriptionName" value={formData.prescriptionName} onChange={handleInputChange} />

              <label>Policy Used:</label>
              <input type="text" name="policyUsed" value={formData.policyUsed} onChange={handleInputChange} />
...
export default HealthCareFrontPage;
